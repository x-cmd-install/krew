...
合计: **9,012** 行代码（覆盖前 5 种语言、共 **122** 个文件）。
...
- **Star**: 7,037 · **Fork**: 411 · **开放 issue**: 388 · **贡献者**: 478

## 累计统计

- **发布数**: 16 · **已合并 PR**: 442 · **开放 PR**: 2 · **已关闭 issue**: 367 · **开放 issue**: 21 · **提交数**: 507
...
| last180d | 2026-03-15 | 0 | 1 | 2 | 0 | 3 | 4 |
| 360d | 2025-09-16 | 1 | 7 | 2 | 3 | 4 | 7 |
| last720d | 2024-09-21 | 2 | 15 | 2 | 18 | 5 | 17 |
...
在 [repology.org](https://repology.org/project/krew) 上共有 **20** 个发行版报告此项目。**11** 个 ✅ 已是最新上游版本，**5** 个 ⚠️ 使用旧版本。

| 发行版 | 版本 | 状态 |
|--------|------|------|
| Arch | `0.5.0` | ✅ latest |
| Homebrew | `0.5.0` | ✅ latest |
...
_数据快照: `data/card/260911.yml` · 2026-09-11T03:05:06Z._
